...
double piOMPEntrelacerAtomic(int n)
    {
       ...
       double sumGlobal=0;
          ...
          #pragma omp parallel shared(sumGlobal) //La variable sumGlobal est partagé par tous les threads, optionelle car comportement par défaut
          {
   	...
   	#pragma omp atomic // Que le prochain opérateur mathématique
      	sumGlobal+=sumLocal;
